...
export interface IQuizInputPartial extends QuizIdentifiers {
  source?: string;
  image?: string;
  explanation?: string;
...
export interface QuestionInputFull
  extends Required<QuestionInput & { quiz: QuizIdentifiers }>,
    QuestionInputCommon {
  answers: string[];
}
