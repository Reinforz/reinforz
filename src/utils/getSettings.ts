...
function checkBoolean<T extends Record<string, string | boolean>>(obj: T, key: keyof T, defaultValue: boolean){
...
export const getSettings = () => {
  ...
  local_settings.sound = checkBoolean(local_settings, 'sound', true);
